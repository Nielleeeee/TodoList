  ...
  return (
    <li className="flex flex-row justify-between">
      ...
      <div className="flex flex-row gap-2">
        <span className={`cursor-pointer ${isEdit ? "flex" : "hidden"}`} onClick={() => setIsEdit(false)}>
        ...
        <span className={`cursor-pointer ${isEdit ? "hidden" : "flex"}`} onClick={() => setIsEdit(true)}>
          <svg fill="#000000" width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M20.7,5.2a1.024,1.024,0,0,1,0,1.448L18.074,9.276l-3.35-3.35L17.35,3.3a1.024,1.024,0,0,1,1.448,0Zm-4.166,5.614-3.35-3.35L4.675,15.975,3,21l5.025-1.675Z"/></svg>
        </span>
